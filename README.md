...
To execute SDK APIs, you need to create a `ManagerSession`. Use the `create_manager_session()` method to configure a session, perform authentication, and obtain a `ManagerSession` instance in an operational state.
