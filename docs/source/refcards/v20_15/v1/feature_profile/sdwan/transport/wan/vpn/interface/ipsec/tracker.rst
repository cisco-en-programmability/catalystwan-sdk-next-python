...
.. code:: python
    ...
    def get_wan_vpn_interface_ipsec_associated_tracker_parcels_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.ipsec.tracker.get_wan_vpn_interface_ipsec_associated_tracker_parcels_for_transport()
...
.. code:: python
    ...
    def get_wan_vpn_interface_ipsec_associated_tracker_parcel_by_parcel_id_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.ipsec.tracker.get_wan_vpn_interface_ipsec_associated_tracker_parcel_by_parcel_id_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.ipsec.tracker.edit_wan_vpn_interface_ipsec_and_tracker_parcel_association_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.ipsec.tracker.delete_wan_vpn_interface_ipsec_and_tracker_association_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.ipsec.tracker.create_wan_vpn_interface_ipsec_and_tracker_parcel_association_for_transport()
