...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.vrf.routing.ospfv3.ipv6.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.vrf.routing.ospfv3.ipv6.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.vrf.routing.ospfv3.ipv6.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.vrf.routing.ospfv3.ipv6.get()
