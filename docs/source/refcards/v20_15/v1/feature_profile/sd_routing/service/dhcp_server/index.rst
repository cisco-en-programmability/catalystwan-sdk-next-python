...
.. code:: python
    ...
    def post(
        service_id: str,
        payload: CreateSdroutingDhcpServerProfileParcelPostRequest,
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.dhcp_server.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.dhcp_server.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.dhcp_server.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.service.dhcp_server.get()
