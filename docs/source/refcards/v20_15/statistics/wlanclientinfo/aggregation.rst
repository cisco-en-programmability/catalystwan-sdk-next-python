...
.. code:: python
    ...
    with create_client(
        ...
        client.statistics.wlanclientinfo.aggregation.get_aggregation_data_by_query_21()
...
.. code:: python
    ...
    with create_client(
        ...
        client.statistics.wlanclientinfo.aggregation.get_post_aggregation_data_by_query_22()
