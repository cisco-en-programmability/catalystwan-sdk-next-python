...
.. code:: python
    ...
    with create_client(
        ...
        client.statistics.sitehealth.aggregation.get_aggregation_data_by_query_15()
...
.. code:: python
    ...
    with create_client(
        ...
        client.statistics.sitehealth.aggregation.get_post_aggregation_data_by_query_16()
