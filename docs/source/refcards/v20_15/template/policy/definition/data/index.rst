...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.data.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.data.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.data.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.data.get()
