...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.qosmap.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.qosmap.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.qosmap.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.qosmap.get()
