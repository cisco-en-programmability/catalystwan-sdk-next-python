...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.dialpeer.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.dialpeer.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.dialpeer.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.dialpeer.get()
