...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.fxsdidport.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.fxsdidport.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.fxsdidport.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.fxsdidport.get()
