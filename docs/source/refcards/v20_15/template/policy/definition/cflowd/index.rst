...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.cflowd.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.cflowd.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.cflowd.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.cflowd.get()
