...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.hubandspoke.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.hubandspoke.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.hubandspoke.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.hubandspoke.get()
