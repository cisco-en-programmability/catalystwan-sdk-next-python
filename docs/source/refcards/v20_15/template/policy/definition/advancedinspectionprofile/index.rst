...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.advancedinspectionprofile.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.advancedinspectionprofile.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.advancedinspectionprofile.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.advancedinspectionprofile.get()
