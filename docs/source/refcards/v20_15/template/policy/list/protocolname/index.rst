...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.protocolname.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.protocolname.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.protocolname.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.protocolname.delete()
