...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.umbrelladata.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.umbrelladata.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.umbrelladata.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.umbrelladata.delete()
