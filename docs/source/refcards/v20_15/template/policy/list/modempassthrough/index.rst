...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.modempassthrough.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.modempassthrough.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.modempassthrough.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.modempassthrough.delete()
