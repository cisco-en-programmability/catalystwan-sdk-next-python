...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefix.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefix.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefix.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefix.delete()
