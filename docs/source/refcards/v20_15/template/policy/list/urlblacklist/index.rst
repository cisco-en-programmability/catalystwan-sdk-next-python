...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.urlblacklist.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.urlblacklist.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.urlblacklist.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.urlblacklist.delete()
