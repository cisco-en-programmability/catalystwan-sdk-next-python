...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.region.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.region.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.region.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.region.delete()
