...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.geolocation.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.geolocation.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.geolocation.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.geolocation.delete()
