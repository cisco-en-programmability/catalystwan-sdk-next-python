...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localdomain.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localdomain.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localdomain.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localdomain.delete()
