...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.faxprotocol.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.faxprotocol.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.faxprotocol.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.faxprotocol.delete()
