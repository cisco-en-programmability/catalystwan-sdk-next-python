...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.preferredcolorgroup.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.preferredcolorgroup.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.preferredcolorgroup.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.preferredcolorgroup.delete()
