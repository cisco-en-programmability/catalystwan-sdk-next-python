...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.ipv6prefix.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.ipv6prefix.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.ipv6prefix.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.ipv6prefix.delete()
