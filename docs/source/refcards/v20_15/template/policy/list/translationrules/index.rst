...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.translationrules.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.translationrules.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.translationrules.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.translationrules.delete()
