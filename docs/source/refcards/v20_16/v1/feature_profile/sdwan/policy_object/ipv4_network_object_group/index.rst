...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.policy_object.ipv4_network_object_group.create_data_prefix_profile_parcel_for_security_policy_object()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.policy_object.ipv4_network_object_group.get_data_prefix_profile_parcel_for_policy_object()
