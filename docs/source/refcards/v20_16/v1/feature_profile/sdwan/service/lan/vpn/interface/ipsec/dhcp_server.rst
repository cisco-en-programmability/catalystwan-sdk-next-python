...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.interface.ipsec.dhcp_server.get_lan_vpn_interface_ipsec_associated_dhcp_server_parcels_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.interface.ipsec.dhcp_server.get_lan_vpn_interface_ipsec_associated_dhcp_server_parcel_by_parcel_id_for_transport()
...
.. code:: python
    ...
    def edit_lan_vpn_interface_ipsec_and_dhcp_server_parcel_association_for_transport(
        service_id: str,
        vpn_id: str,
        ipsec_id: str,
        dhcp_server_id: str,
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.interface.ipsec.dhcp_server.edit_lan_vpn_interface_ipsec_and_dhcp_server_parcel_association_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.interface.ipsec.dhcp_server.delete_lan_vpn_interface_ipsec_and_dhcp_server_association_for_transport()
...
.. code:: python
    ...
    def create_lan_vpn_interface_ipsec_and_dhcp_server_parcel_association_for_transport(
        service_id: str,
        vpn_parcel_id: str,
        ipsec_id: str,
        payload: Optional[str] = None,
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.interface.ipsec.dhcp_server.create_lan_vpn_interface_ipsec_and_dhcp_server_parcel_association_for_transport()
