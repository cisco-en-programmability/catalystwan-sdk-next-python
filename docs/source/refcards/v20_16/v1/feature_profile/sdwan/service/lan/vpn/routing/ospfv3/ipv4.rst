...
.. code:: python
    ...
    def get_lan_vpn_associated_routing_ospfv3_i_pv4_parcels_for_service(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.routing.ospfv3.ipv4.get_lan_vpn_associated_routing_ospfv3_i_pv4_parcels_for_service()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.routing.ospfv3.ipv4.create_lan_vpn_and_routing_ospfv3_i_pv4_parcel_association_for_service()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.routing.ospfv3.ipv4.get_lan_vpn_associated_routing_ospfv3_i_pv4_parcel_by_parcel_id_for_service()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.routing.ospfv3.ipv4.edit_lan_vpn_and_routing_ospfv3_i_pv4_parcel_association_for_service()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.service.lan.vpn.routing.ospfv3.ipv4.delete_lan_vpn_and_routing_ospfv3_association_for_service()
