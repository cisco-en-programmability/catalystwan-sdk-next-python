...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.get()
