...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.routing.ospfv3.ipv6.get_routing_ospfv3_ipv6_af_profile_parcel_for_transport()
...
.. code:: python
    ...
    def create_routing_ospfv3_ipv6_af_profile_parcel_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.routing.ospfv3.ipv6.create_routing_ospfv3_ipv6_af_profile_parcel_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.routing.ospfv3.ipv6.get_routing_ospfv3_ipv6_af_profile_parcel_by_parcel_id_for_transport()
...
.. code:: python
    ...
    def edit_routing_ospfv3_ipv6_af_profile_parcel_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.routing.ospfv3.ipv6.edit_routing_ospfv3_ipv6_af_profile_parcel_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.routing.ospfv3.ipv6.delete_routing_ospfv3_ipv6_af_profile_parcel_for_transport()
