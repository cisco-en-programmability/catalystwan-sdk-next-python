=====================================================================
v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker
=====================================================================


Operation: GET /dataservice/v1/feature-profile/sdwan/transport/{transportId}/wan/vpn/{vpnId}/interface/cellular/{cellularId}/tracker
------------------------------------------------------------------------------------------------------------------------------------
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.get_wan_vpn_interface_cellular_associated_tracker_parcels_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.get_wan_vpn_interface_cellular_associated_tracker_parcel_by_parcel_id_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport()


Operation: DELETE /dataservice/v1/feature-profile/sdwan/transport/{transportId}/wan/vpn/{vpnId}/interface/cellular/{cellularId}/tracker/{trackerId}
---------------------------------------------------------------------------------------------------------------------------------------------------
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.delete_wan_vpn_interface_cellular_and_tracker_association_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.interface.cellular.tracker.create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport()
