...
.. code:: python
    ...
    def get_wan_vpn_associated_routing_ospfv3_i_pv6_af_parcels_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.routing.ospfv3.ipv6.get_wan_vpn_associated_routing_ospfv3_i_pv6_af_parcels_for_transport()
...
.. code:: python
    ...
    def create_wan_vpn_and_routing_ospfv3_ipv6_af_parcel_association_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.routing.ospfv3.ipv6.create_wan_vpn_and_routing_ospfv3_ipv6_af_parcel_association_for_transport()
...
.. code:: python
    ...
    def get_wan_vpn_associated_routing_ospfv3_i_pv6_af_parcel_by_parcel_id_for_transport(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.routing.ospfv3.ipv6.get_wan_vpn_associated_routing_ospfv3_i_pv6_af_parcel_by_parcel_id_for_transport()
...
.. code:: python
    ...
    def edit_wan_vpn_and_routing_ospfv3_i_pv6_af_parcel_association_for_transport(
        transport_id: str,
        vpn_id: str,
        ospfv3_id: str,
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.routing.ospfv3.ipv6.edit_wan_vpn_and_routing_ospfv3_i_pv6_af_parcel_association_for_transport()
...
.. code:: python
    ...
    def delete_wan_vpn_and_routing_ospfv3_i_pv6_association_for_transport(
        transport_id: str, vpn_id: str, ospfv3_id: str
    ) -> None: ...
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sdwan.transport.wan.vpn.routing.ospfv3.ipv6.delete_wan_vpn_and_routing_ospfv3_i_pv6_association_for_transport()
