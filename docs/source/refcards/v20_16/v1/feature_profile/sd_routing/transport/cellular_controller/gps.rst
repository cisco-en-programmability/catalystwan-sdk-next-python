...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.cellular_controller.gps.get_cellular_controller_associated_gps_parcels_for_transport_1()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.cellular_controller.gps.create_cellular_controller_and_gps_parcel_association_for_transport_1()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.cellular_controller.gps.get_cellular_controller_associated_gps_parcel_by_parcel_id_for_transport_1()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.cellular_controller.gps.delete_cellular_controller_and_gps_association_for_transport_1()
