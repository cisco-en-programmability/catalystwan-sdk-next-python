...
.. code:: python
    ...
    def get_transport_vrf_associated_routing_ospfv3_ipv4_features_1(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.routing.ospfv3.ipv4.get_transport_vrf_associated_routing_ospfv3_ipv4_features_1()
...
.. code:: python
    ...
    def create_transport_vrf_and_routing_ospfv3_ipv4_association(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.routing.ospfv3.ipv4.create_transport_vrf_and_routing_ospfv3_ipv4_association()
...
.. code:: python
    ...
    def get_vrf_associated_routing_ospfv3_ipv4_feature_by_id_1(
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.routing.ospfv3.ipv4.get_vrf_associated_routing_ospfv3_ipv4_feature_by_id_1()
...
.. code:: python
    ...
    def edit_transport_vrf_and_routing_ospfv3_ipv4_association(
        transport_id: str,
        vrf_id: str,
        ospfv3_id: str,
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.routing.ospfv3.ipv4.edit_transport_vrf_and_routing_ospfv3_ipv4_association()
...
.. code:: python
    ...
    def delete_transport_vrf_and_routing_ospfv3_ipv4_association(
        transport_id: str, vrf_id: str, ospfv3_id: str
    ) -> None: ...
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.routing.ospfv3.ipv4.delete_transport_vrf_and_routing_ospfv3_ipv4_association()
