...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.interface.ipsec.get_sdrouting_transport_global_vrf_interface_ipsec_features_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.interface.ipsec.create_sdrouting_transport_global_vrf_interface_ipsec_feature_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.interface.ipsec.get_sdrouting_transport_global_vrf_interface_ipsec_feature_by_feature_id_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.interface.ipsec.edit_sdrouting_transport_global_vrf_interface_ipsec_feature_for_transport()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.interface.ipsec.delete_sdrouting_transport_global_vrf_interface_ipsec_feature_for_transport()
