...
.. code:: python
    ...
    def get_sdrouting_transport_global_vrf_bgp_features(
        transport_id: str,
    ) -> str: ...
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.get_sdrouting_transport_global_vrf_bgp_features()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.create_sdrouting_transport_global_vrf_bgp_feature()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.get_sdrouting_transport_global_vrf_bgp_feature()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.edit_sdrouting_transport_global_vrf_bgp_feature()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.delete_sdrouting_transport_global_vrf_bgp_feature()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.get_transport_vrf_associated_routing_bgp_features()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.create_transport_global_vrf_and_routing_bgp_feature_association()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.get_vrf_associated_routing_bgp_feature_by_id()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.edit_transport_global_vrf_and_routing_bgp_feature_association()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.bgp.delete_transport_global_vrf_and_routing_bgp_association()
