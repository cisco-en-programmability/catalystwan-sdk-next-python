======================================================================
v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6
======================================================================


Operation: GET /dataservice/v1/feature-profile/sd-routing/transport/{transportId}/global-vrf/{vrfId}/routing/ospfv3/ipv6
------------------------------------------------------------------------------------------------------------------------
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6.get_transport_vrf_associated_routing_ospfv3_ipv6_features()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6.create_transport_global_vrf_and_routing_ospfv3_ipv6_parcel_association()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6.get_vrf_associated_routing_ospfv3_ipv6_feature_by_id()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6.edit_transport_global_vrf_and_routing_ospfv3_ipv6_feature_association()


Operation: DELETE /dataservice/v1/feature-profile/sd-routing/transport/{transportId}/global-vrf/{vrfId}/routing/ospfv3/ipv6/{ospfv3Id}
--------------------------------------------------------------------------------------------------------------------------------------
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.global_vrf.routing.ospfv3.ipv6.delete_transport_global_vrf_and_routing_ospfv3_ipv6_association()
