...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.interface.ethernet.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.interface.ethernet.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.interface.ethernet.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.v1.feature_profile.sd_routing.transport.vrf.interface.ethernet.get()
