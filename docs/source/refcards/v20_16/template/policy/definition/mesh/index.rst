...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.mesh.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.mesh.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.mesh.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.mesh.get()
