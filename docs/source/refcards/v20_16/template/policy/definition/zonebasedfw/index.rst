...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.zonebasedfw.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.zonebasedfw.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.zonebasedfw.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.zonebasedfw.get()
