...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.control.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.control.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.control.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.control.get()
