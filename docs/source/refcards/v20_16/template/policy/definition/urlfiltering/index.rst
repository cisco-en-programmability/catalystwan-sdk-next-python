...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.urlfiltering.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.urlfiltering.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.urlfiltering.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.urlfiltering.get()
