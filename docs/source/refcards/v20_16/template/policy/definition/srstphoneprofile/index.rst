...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.srstphoneprofile.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.srstphoneprofile.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.srstphoneprofile.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.srstphoneprofile.get()
