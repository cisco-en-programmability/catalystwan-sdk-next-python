...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.acl.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.acl.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.acl.delete()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.definition.acl.get()
