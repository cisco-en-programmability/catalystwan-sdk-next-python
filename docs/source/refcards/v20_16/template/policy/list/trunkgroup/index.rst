...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.trunkgroup.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.trunkgroup.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.trunkgroup.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.trunkgroup.delete()
