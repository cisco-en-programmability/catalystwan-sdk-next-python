...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.policer.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.policer.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.policer.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.policer.delete()
