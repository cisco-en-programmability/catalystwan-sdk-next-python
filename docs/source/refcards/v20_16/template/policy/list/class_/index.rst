...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.class_.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.class_.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.class_.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.class_.delete()
