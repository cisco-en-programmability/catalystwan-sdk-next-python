...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.expandedcommunity.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.expandedcommunity.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.expandedcommunity.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.expandedcommunity.delete()
