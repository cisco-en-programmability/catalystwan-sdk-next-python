...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localapp.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localapp.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localapp.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.localapp.delete()
