...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.supervisorydisc.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.supervisorydisc.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.supervisorydisc.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.supervisorydisc.delete()
