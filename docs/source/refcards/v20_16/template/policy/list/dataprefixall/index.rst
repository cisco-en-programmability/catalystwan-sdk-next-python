...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefixall.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefixall.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefixall.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataprefixall.delete()
