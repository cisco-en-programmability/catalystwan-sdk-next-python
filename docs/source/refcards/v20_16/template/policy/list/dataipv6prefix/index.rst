...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataipv6prefix.post()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataipv6prefix.put()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataipv6prefix.get()
...
.. code:: python
    ...
    with create_client(
        ...
        client.template.policy.list.dataipv6prefix.delete()
