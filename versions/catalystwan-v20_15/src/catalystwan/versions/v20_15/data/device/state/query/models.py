...
class GenerateDeviceStateDataData:
    ...
    create_time_stamp: Optional[str] = _field(
        default=None, metadata={"alias": "createTimeStamp"}
    )
    description: Optional[str] = _field(default=None)
    hwaddr: Optional[str] = _field(default=None)
    if_admin_status: Optional[str] = _field(
        default=None, metadata={"alias": "if-admin-status"}
    )
    if_oper_status: Optional[str] = _field(
        default=None, metadata={"alias": "if-oper-status"}
    )
    ifindex: Optional[str] = _field(default=None)
    ifname: Optional[str] = _field(default=None)
    interface_type: Optional[str] = _field(
        default=None, metadata={"alias": "interface-type"}
    )
    ip_address: Optional[str] = _field(default=None, metadata={"alias": "ip-address"})
    ipv4_subnet_mask: Optional[str] = _field(
        default=None, metadata={"alias": "ipv4-subnet-mask"}
    )
    ...
    vdevice_data_key: Optional[str] = _field(
        default=None, metadata={"alias": "vdevice-dataKey"}
    )
    vdevice_host_name: Optional[str] = _field(
        default=None, metadata={"alias": "vdevice-host-name"}
    )
    vdevice_name: Optional[str] = _field(
        default=None, metadata={"alias": "vdevice-name"}
    )
