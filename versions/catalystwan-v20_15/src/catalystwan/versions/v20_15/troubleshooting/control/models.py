...
class TlocControl:
    ...
    is_preferred: Optional[bool] = _field(
        default=None, metadata={"alias": "is-preferred"}
    )
    local_status: Optional[LocalStatus] = _field(
        default=None, metadata={"alias": "local-status"}
    )
    local_status_info: Optional[str] = _field(
        default=None, metadata={"alias": "local-status-info"}
    )
    peer_type: Optional[PeerType] = _field(
        default=None, metadata={"alias": "peer-type"}
    )
    remote_status: Optional[LocalStatus] = _field(
...
class ControlConnectionInfo:
    ...
    private_port: Optional[str] = _field(
        default=None, metadata={"alias": "private-port"}
    )
    ...
    tloc_status: Optional[LocalStatus] = _field(
        default=None, metadata={"alias": "tloc-status"}
    )
