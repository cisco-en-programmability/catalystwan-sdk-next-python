...
class DeviceReachableData:
    ...
    board_serial: Optional[int] = _field(
    ...
    cpu_load_display: Optional[int] = _field(
        default=None, metadata={"alias": "cpuLoadDisplay"}
    )
    cpu_state: Optional[str] = _field(default=None, metadata={"alias": "cpuState"})
    default_version: Optional[str] = _field(
        default=None, metadata={"alias": "defaultVersion"}
    )
    device_category: Optional[str] = _field(
        default=None, metadata={"alias": "device-category"}
    )
    device_groups: Optional[List[str]] = _field(
        default=None, metadata={"alias": "device-groups"}
    )
    ...
    firmware_version: Optional[str] = _field(
        default=None, metadata={"alias": "firmwareVersion"}
    )
    grid: Optional[int] = _field(default=None)
    group_id: Optional[List[str]] = _field(default=None, metadata={"alias": "groupId"})
    hardware_state: Optional[str] = _field(
        default=None, metadata={"alias": "hardwareState"}
    )
    has_geo_data: Optional[bool] = _field(
        default=None, metadata={"alias": "hasGeoData"}
    )
    host_name: Optional[str] = _field(default=None, metadata={"alias": "host-name"})
    is_device_geo_data: Optional[bool] = _field(
        default=None, metadata={"alias": "isDeviceGeoData"}
    )
    ...
    mem_statenormal: Optional[str] = _field(
        default=None, metadata={"alias": "memStatenormal"}
    )
    mem_usage: Optional[int] = _field(default=None, metadata={"alias": "memUsage"})
    mem_usage_display: Optional[int] = _field(
        default=None, metadata={"alias": "memUsageDisplay"}
    )
    ...
    omp_peers_down: Optional[int] = _field(
        default=None, metadata={"alias": "ompPeersDown"}
    )
    omp_peers_up: Optional[int] = _field(default=None, metadata={"alias": "ompPeersUp"})
    organization_name: Optional[str] = _field(
        default=None, metadata={"alias": "organization-name"}
    )
    ...
    status_order: Optional[int] = _field(
        default=None, metadata={"alias": "statusOrder"}
    )
    sync_completed: Optional[int] = _field(
        default=None, metadata={"alias": "syncCompleted"}
    )
    sync_queued: Optional[int] = _field(default=None, metadata={"alias": "syncQueued"})
    sync_scheduled: Optional[int] = _field(
        default=None, metadata={"alias": "syncScheduled"}
    )
    ...
    vmanage_system_ip: Optional[str] = _field(
        default=None, metadata={"alias": "vmanage-system-ip"}
    )
