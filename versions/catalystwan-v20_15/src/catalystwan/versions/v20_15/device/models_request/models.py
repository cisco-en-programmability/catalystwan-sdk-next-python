...
class DeviceCpuCount:
    attribute_field: Optional[str] = _field(
        default=None, metadata={"alias": "attributeField"}
    )
...
class DeviceModelsData:
    ...
    device_class: Optional[str] = _field(
        default=None, metadata={"alias": "deviceClass"}
    )
    ...
    is_cli_supported: Optional[bool] = _field(
        default=None, metadata={"alias": "isCliSupported"}
    )
    name: Optional[str] = _field(default=None)
    onboard_cert: Optional[bool] = _field(
        default=None, metadata={"alias": "onboardCert"}
    )
    template_class: Optional[str] = _field(
        default=None, metadata={"alias": "templateClass"}
    )
