...
class ImageData:
    ...
    display_checksum: Optional[str] = _field(
        default=None, metadata={"alias": "displayChecksum"}
    )
    ...
    file_entries: Optional[Dict[str, str]] = _field(
        default=None, metadata={"alias": "fileEntries"}
    )
    file_name: Optional[str] = _field(default=None, metadata={"alias": "fileName"})
    file_size_str: Optional[str] = _field(
        default=None, metadata={"alias": "fileSizeStr"}
    )
    file_sizebyte: Optional[str] = _field(
        default=None, metadata={"alias": "fileSizebyte"}
    )
    image_properties_json: Optional[str] = _field(
        default=None, metadata={"alias": "imagePropertiesJson"}
    )
    image_type: Optional[ImageType] = _field(
        default=None, metadata={"alias": "imageType"}
    )
    image_type_name: Optional[str] = _field(
        default=None, metadata={"alias": "imageTypeName"}
    )
    md5_checksum: Optional[str] = _field(
        default=None, metadata={"alias": "md5Checksum"}
    )
    ...
    remote_servers: Optional[str] = _field(
        default=None, metadata={"alias": "remoteServers"}
    )
    sha256_checksum: Optional[str] = _field(
        default=None, metadata={"alias": "sha256Checksum"}
    )
    sha512_checksum: Optional[str] = _field(
        default=None, metadata={"alias": "sha512Checksum"}
    )
    smu_compatible_with: Optional[str] = _field(
        default=None, metadata={"alias": "smuCompatibleWith"}
    )
    smu_defect_id: Optional[str] = _field(
        default=None, metadata={"alias": "smuDefectId"}
    )
    smu_description: Optional[str] = _field(
        default=None, metadata={"alias": "smuDescription"}
    )
    smu_type: Optional[str] = _field(default=None, metadata={"alias": "smuType"})
    storage_data: Optional[str] = _field(
        default=None, metadata={"alias": "storageData"}
    )
    ...
    temp_image_path: Optional[str] = _field(
        default=None, metadata={"alias": "tempImagePath"}
    )
    updated_file_name: Optional[str] = _field(
        default=None, metadata={"alias": "updatedFileName"}
    )
    version: Optional[str] = _field(default=None)
    version_type_name: Optional[str] = _field(
        default=None, metadata={"alias": "versionTypeName"}
    )
