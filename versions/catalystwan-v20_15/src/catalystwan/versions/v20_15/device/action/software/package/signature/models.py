...
class ImageData:
    ...
    application_vendor_vendor: Optional[str] = _field(default=None, metadata={"alias": "applicationVendorVendor"})
    arch: Optional[str] = _field(default=None)
    controller_version: Optional[str] = _field(default=None, metadata={"alias": "controllerVersion"})
    ...
    display_checksum_type: Optional[str] = _field(default=None, metadata={"alias": "displayChecksumType"})
    display_checksum_validity: Optional[str] = _field(default=None, metadata={"alias": "displayChecksumValidity"})
    ...
    image_properties_json: Optional[str] = _field(default=None, metadata={"alias": "imagePropertiesJson"})
    ...
    network_function_type: Optional[str] = _field(default=None, metadata={"alias": "networkFunctionType"})
    ...
    smu_compatible_with: Optional[str] = _field(default=None, metadata={"alias": "smuCompatibleWith"})
    ...
    system_properties_xml: Optional[str] = _field(default=None, metadata={"alias": "systemPropertiesXml"})
    ...
    vnf_properties_json: Optional[str] = _field(default=None, metadata={"alias": "vnfPropertiesJson"})
