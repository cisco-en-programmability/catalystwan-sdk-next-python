...
class GenerateDeviceListData:
    ...
    current_partition: Optional[str] = _field(
        default=None, metadata={"alias": "current-partition"}
    )
    ...
    platform_family: Optional[str] = _field(
        default=None, metadata={"alias": "platformFamily"}
    )
