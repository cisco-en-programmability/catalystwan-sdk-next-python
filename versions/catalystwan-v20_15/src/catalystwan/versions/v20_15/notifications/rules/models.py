...
class NotificationsRuleData:
    ...
    account_details: Optional[str] = _field(
        default=None, metadata={"alias": "accountDetails"}
    )
    alarm_name: Optional[str] = _field(default=None, metadata={"alias": "alarmName"})
    devices_attached: Optional[str] = _field(
        default=None, metadata={"alias": "devicesAttached"}
    )
    email_threshold: Optional[int] = _field(
        default=None, metadata={"alias": "emailThreshold"}
    )
    ...
    webhook_password: Optional[str] = _field(
        default=None, metadata={"alias": "webhookPassword"}
    )
    webhook_url: Optional[str] = _field(default=None, metadata={"alias": "webhookUrl"})
    webhook_username: Optional[str] = _field(
        default=None, metadata={"alias": "webhookUsername"}
    )
