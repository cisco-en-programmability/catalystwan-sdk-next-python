...
class VpnmembershipgroupBuilder:
    ...
    def get_definitions_6(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_6(self):
        class create_policy_definition_6_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_6_(self._request_adapter)
    ...
    @property
    def edit_policy_definition_6(self):
        class edit_policy_definition_6_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_6_(self._request_adapter)

    def delete_policy_definition_6(self, id: str, **kw):
        """
