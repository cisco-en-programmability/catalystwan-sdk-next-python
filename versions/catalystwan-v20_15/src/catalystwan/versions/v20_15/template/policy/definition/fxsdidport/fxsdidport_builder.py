...
class FxsdidportBuilder:
    ...
    def get_definitions_28(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_28(self):
        class create_policy_definition_28_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_28_(self._request_adapter)

    def get_policy_definition_28(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_definition_28(self):
        class edit_policy_definition_28_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_28_(self._request_adapter)
