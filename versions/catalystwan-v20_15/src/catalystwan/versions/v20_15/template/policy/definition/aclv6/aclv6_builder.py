...
class Aclv6Builder:
    ...
    def get_definitions_9(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_9(self):
        class create_policy_definition_9_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_9_(self._request_adapter)

    def get_policy_definition_9(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_definition_9(self):
        class edit_policy_definition_9_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_9_(self._request_adapter)
