...
class PreviewBuilder:
    ...
    def preview_policy_definition_21(self, payload: Optional[Any] = None, **kw) -> Any:
        ...
        return self._request_adapter.request(
            "POST", "/dataservice/template/policy/definition/securitygroup/preview", payload=payload, **kw
        )
    ...
    def preview_policy_definition_by_id_21(self, id: str, **kw) -> Any:
        ...
        return self._request_adapter.request(
            "GET", "/dataservice/template/policy/definition/securitygroup/preview/{id}", params=params, **kw
        )
