...
class MeshBuilder:
    ...
    def get_definitions_5(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_5(self):
        class create_policy_definition_5_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_5_(self._request_adapter)

    def get_policy_definition_5(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_definition_5(self):
        class edit_policy_definition_5_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_5_(self._request_adapter)
