...
class SrstphoneprofileBuilder:
    ...
    def get_definitions_30(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_30(self):
        class create_policy_definition_30_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_30_(self._request_adapter)
    ...
    @property
    def edit_policy_definition_30(self):
        class edit_policy_definition_30_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_30_(self._request_adapter)
