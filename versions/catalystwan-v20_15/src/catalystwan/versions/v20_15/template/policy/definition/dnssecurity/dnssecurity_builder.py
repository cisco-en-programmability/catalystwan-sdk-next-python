...
class DnssecurityBuilder:
    ...
    def create_policy_definition(self):
        class create_policy_definition_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_(self._request_adapter)
    ...
    def edit_policy_definition(self):
        ...
        return edit_policy_definition_(self._request_adapter)
