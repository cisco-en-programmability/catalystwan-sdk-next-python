...
class RewriteruleBuilder:
    ...
    def get_definitions_19(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_19(self):
        class create_policy_definition_19_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_19_(self._request_adapter)

    def get_policy_definition_19(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_definition_19(self):
        class edit_policy_definition_19_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_19_(self._request_adapter)
