...
class SslutdprofileBuilder:
    ...
    def get_definitions_22(self, **kw) -> Any:
        ...
        :returns: Any
        """
        return self._request_adapter.request("GET", "/dataservice/template/policy/definition/sslutdprofile", **kw)
    ...
    def edit_policy_definition_22(self, id: str, payload: Optional[Any] = None, **kw) -> Any:
        ...
        return self._request_adapter.request(
            "PUT", "/dataservice/template/policy/definition/sslutdprofile/{id}", params=params, payload=payload, **kw
        )
    ...
    def delete_policy_definition_22(self, id: str, **kw):
        ...
        return self._request_adapter.request(
            "DELETE", "/dataservice/template/policy/definition/sslutdprofile/{id}", params=params, **kw
        )
