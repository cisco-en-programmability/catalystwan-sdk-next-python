...
class PortBuilder:
    ...
    @property
    def create_policy_list_27(self):
        class create_policy_list_27_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_list_27_(self._request_adapter)
    ...
    @property
    def edit_policy_list_27(self):
        class edit_policy_list_27_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_list_27_(self._request_adapter)
