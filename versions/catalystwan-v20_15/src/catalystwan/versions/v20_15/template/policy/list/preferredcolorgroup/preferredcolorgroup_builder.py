...
class PreferredcolorgroupBuilder:
    ...
    def get_policy_lists_25(self, **kw) -> List[Any]:
        """
        Get policy lists
    ...
    @property
    def create_policy_list_28(self):
        class create_policy_list_28_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_list_28_(self._request_adapter)
    ...
    def get_lists_by_id_28(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_list_28(self):
        class edit_policy_list_28_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_list_28_(self._request_adapter)
