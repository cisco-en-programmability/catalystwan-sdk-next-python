...
class LocalappBuilder:
    ...
    def get_policy_lists_19(self, **kw) -> List[Any]:
        """
        Get policy lists
    ...
    @property
    def create_policy_list_22(self):
        class create_policy_list_22_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_list_22_(self._request_adapter)
    ...
    @property
    def edit_policy_list_22(self):
        class edit_policy_list_22_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_list_22_(self._request_adapter)
