...
class QosmapBuilder:
    ...
    def get_definitions_1(self, **kw) -> Any:
        """
    ...
    @property
    def create_policy_definition_1(self):
        class create_policy_definition_1_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_policy_definition_1_(self._request_adapter)

    def get_policy_definition_1(self, id: str, **kw) -> Any:
        """
    ...
    @property
    def edit_policy_definition_1(self):
        class edit_policy_definition_1_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_definition_1_(self._request_adapter)
