...
class ExtcommunityBuilder:
    ...
    def delete_policy_lists_with_info_tag_12(self, info_tag: Optional[str] = None, **kw) -> List[Any]:
        """
        ...
        return self._request_adapter.request(
            "DELETE", "/dataservice/template/policy/list/extcommunity", return_type=List[Any], params=params, **kw
        )
    ...
    def edit_policy_list_12(self, id: str, payload: Optional[Any] = None, **kw) -> Any:
        ...
        return self._request_adapter.request(
            "PUT", "/dataservice/template/policy/list/extcommunity/{id}", params=params, payload=payload, **kw
        )
