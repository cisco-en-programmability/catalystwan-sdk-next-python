...
class MediaprofileBuilder:
    ...
    def create_policy_list(self):
        ...
        return create_policy_list_(self._request_adapter)
    ...
    @property
    def edit_policy_list(self):
        class edit_policy_list_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_policy_list_(self._request_adapter)
