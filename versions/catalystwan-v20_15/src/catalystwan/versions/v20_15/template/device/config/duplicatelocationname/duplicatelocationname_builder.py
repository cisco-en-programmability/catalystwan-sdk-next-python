...
class DuplicatelocationnameBuilder:
    ...
    @property
    def get_devices_with_duplicate_location_name(self):
        class get_devices_with_duplicate_location_name_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return get_devices_with_duplicate_location_name_(self._request_adapter)
