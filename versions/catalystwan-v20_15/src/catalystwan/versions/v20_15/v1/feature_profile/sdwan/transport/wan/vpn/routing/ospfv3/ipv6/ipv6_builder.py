...
class Ipv6Builder:
    ...
    @property
    def create_wan_vpn_and_routing_ospfv3_ipv6_af_parcel_association_for_transport(self):
        class create_wan_vpn_and_routing_ospfv3_ipv6_af_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_wan_vpn_and_routing_ospfv3_ipv6_af_parcel_association_for_transport_(self._request_adapter)
    ...
    @property
    def edit_wan_vpn_and_routing_ospfv3_i_pv6_af_parcel_association_for_transport(self):
        class edit_wan_vpn_and_routing_ospfv3_i_pv6_af_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_wan_vpn_and_routing_ospfv3_i_pv6_af_parcel_association_for_transport_(self._request_adapter)
