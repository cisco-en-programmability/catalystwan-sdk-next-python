...
class Ipv6TrackergroupBuilder:
    ...
    @property
    def edit_wan_vpn_interface_cellular_and_ipv6_tracker_group_parcel_association_for_transport(self):
    ...
    @property
    def create_wan_vpn_interface_cellular_and_ipv6_tracker_group_parcel_association_for_transport(self):
