...
class VpnBuilder:
    ...
    @property
    def create_wan_vpn_profile_parcel_for_transport(self):
        class create_wan_vpn_profile_parcel_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
    ...
    @property
    def edit_wan_vpn_profile_parcel_for_transport(self):
        class edit_wan_vpn_profile_parcel_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
