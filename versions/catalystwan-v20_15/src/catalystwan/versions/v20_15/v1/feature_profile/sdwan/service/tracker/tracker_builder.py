...
class TrackerBuilder:
    ...
    def get_tracker_profile_parcel_by_parcel_id_for_service(self, service_id: str, tracker_id: str, **kw) -> str:
        """
    ...
    def edit_tracker_profile_parcel_for_service(self):
        class edit_tracker_profile_parcel_for_service_:
            ...
            def __call__(self, service_id: str, tracker_id: str, payload: Optional[str] = None, **kw) -> str:
                """
    ...
    def delete_tracker_profile_parcel_for_service(self, service_id: str, tracker_id: str, **kw):
        """
