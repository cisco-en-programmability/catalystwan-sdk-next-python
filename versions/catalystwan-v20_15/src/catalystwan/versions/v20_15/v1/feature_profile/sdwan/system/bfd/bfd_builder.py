...
class BfdBuilder:
    ...
    @property
    def create_bfd_profile_parcel_for_system(self):
        class create_bfd_profile_parcel_for_system_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
    ...
    @property
    def edit_bfd_profile_parcel_for_system(self):
        class edit_bfd_profile_parcel_for_system_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_bfd_profile_parcel_for_system_(self._request_adapter)
