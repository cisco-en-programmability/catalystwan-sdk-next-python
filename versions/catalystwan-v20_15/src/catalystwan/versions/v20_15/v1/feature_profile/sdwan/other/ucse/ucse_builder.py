...
class UcseBuilder:
    ...
    @property
    def create_ucse_profile_feature_for_other(self):
        class create_ucse_profile_feature_for_other_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
    ...
    @property
    def edit_ucse_profile_feature_for_other(self):
        class edit_ucse_profile_feature_for_other_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_ucse_profile_feature_for_other_(self._request_adapter)
