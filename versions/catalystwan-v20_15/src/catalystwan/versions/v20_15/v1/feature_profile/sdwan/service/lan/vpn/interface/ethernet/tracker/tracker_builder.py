...
class TrackerBuilder:
    ...
    @property
    def edit_lan_vpn_interface_ethernet_and_tracker_parcel_association_for_transport(self):
        ...
        return edit_lan_vpn_interface_ethernet_and_tracker_parcel_association_for_transport_(self._request_adapter)
    ...
    @property
    def create_lan_vpn_interface_ethernet_and_tracker_parcel_association_for_transport(self):
        ...
        return create_lan_vpn_interface_ethernet_and_tracker_parcel_association_for_transport_(self._request_adapter)
