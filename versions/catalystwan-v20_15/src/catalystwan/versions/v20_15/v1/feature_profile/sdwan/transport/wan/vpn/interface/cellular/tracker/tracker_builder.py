...
class TrackerBuilder:
    ...
    @property
    def edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport(self):
        class edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_(self._request_adapter)
    ...
    @property
    def create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport(self):
        class create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_(self._request_adapter)
