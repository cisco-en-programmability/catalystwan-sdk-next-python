...
class TrackerBuilder:
    ...
    def edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport(
        ...
        return edit_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_(
    ...
    def create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport(
        ...
        return create_wan_vpn_interface_cellular_and_tracker_parcel_association_for_transport_(
            self._request_adapter
        )
