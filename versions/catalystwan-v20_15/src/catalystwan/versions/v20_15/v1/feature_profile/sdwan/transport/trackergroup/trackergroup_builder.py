...
class TrackergroupBuilder:
    ...
    def get_tracker_group_profile_parcel_for_transport(self, transport_id: str, **kw) -> str:
        """
    ...
    def edit_tracker_group_profile_parcel_for_transport(self):
        class edit_tracker_group_profile_parcel_for_transport_:
            ...
            def __call__(self, transport_id: str, trackergroup_id: str, payload: Optional[str] = None, **kw) -> str:
                """
    ...
    def delete_tracker_group_profile_parcel_for_transport(self, transport_id: str, trackergroup_id: str, **kw):
        """
