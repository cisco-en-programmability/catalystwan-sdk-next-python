...
class Ipv4Builder:
    ...
    def get_routing_ospfv3_ipv4_af_profile_parcel_for_transport(self, transport_id: str, **kw) -> str:
        """
    ...
    @property
    def create_routing_ospfv3_ipv4_af_profile_parcel_for_transport(self):
        class create_routing_ospfv3_ipv4_af_profile_parcel_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_routing_ospfv3_ipv4_af_profile_parcel_for_transport_(self._request_adapter)
    ...
    @property
    def edit_routing_ospfv3_ipv4_af_profile_parcel_for_transport(self):
        class edit_routing_ospfv3_ipv4_af_profile_parcel_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_routing_ospfv3_ipv4_af_profile_parcel_for_transport_(self._request_adapter)

    def delete_routing_ospfv3_ipv4_af_profile_parcel_for_transport(self, transport_id: str, ospfv3_id: str, **kw):
        """
