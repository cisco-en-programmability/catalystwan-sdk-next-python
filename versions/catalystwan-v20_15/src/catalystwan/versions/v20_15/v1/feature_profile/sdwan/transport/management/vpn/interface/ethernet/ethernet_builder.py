...
class EthernetBuilder:
    ...
    def get_interface_ethernet_parcels_for_transport_management_vpn(self, transport_id: str, vpn_id: str, **kw) -> str:
        """
    ...
    def create_management_vpn_interface_ethernet_parcel_for_transport(self):
        ...
        return create_management_vpn_interface_ethernet_parcel_for_transport_(self._request_adapter)
    ...
    def edit_management_vpn_interface_ethernet_parcel_for_transport(self):
        ...
        return edit_management_vpn_interface_ethernet_parcel_for_transport_(self._request_adapter)
