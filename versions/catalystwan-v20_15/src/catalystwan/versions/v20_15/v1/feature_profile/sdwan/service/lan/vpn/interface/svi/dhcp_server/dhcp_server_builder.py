...
class DhcpServerBuilder:
    ...
    @property
    def edit_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport(self):
        class edit_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport_(self._request_adapter)
    ...
    @property
    def create_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport(self):
        class create_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_lan_vpn_interface_svi_and_dhcp_server_parcel_association_for_transport_(self._request_adapter)
