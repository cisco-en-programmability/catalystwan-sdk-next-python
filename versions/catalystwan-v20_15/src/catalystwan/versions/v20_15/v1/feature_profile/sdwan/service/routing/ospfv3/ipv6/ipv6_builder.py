...
class Ipv6Builder:
    ...
    @property
    def create_routing_ospfv3_ipv6_af_profile_parcel_for_service(self):
        class create_routing_ospfv3_ipv6_af_profile_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_routing_ospfv3_ipv6_af_profile_parcel_for_service_(self._request_adapter)
    ...
    @property
    def edit_routing_ospfv3_i_pv6_af_profile_parcel_for_service(self):
        class edit_routing_ospfv3_i_pv6_af_profile_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return edit_routing_ospfv3_i_pv6_af_profile_parcel_for_service_(self._request_adapter)

    def delete_routing_ospfv3_i_pv6_af_profile_parcel_for_service(self, service_id: str, ospfv3_id: str, **kw):
        """
