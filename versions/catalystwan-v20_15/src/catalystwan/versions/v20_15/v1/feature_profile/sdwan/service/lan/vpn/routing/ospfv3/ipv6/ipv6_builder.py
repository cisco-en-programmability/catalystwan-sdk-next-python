...
class Ipv6Builder:
    ...
    def create_lan_vpn_and_routing_ospfv3_i_pv6_parcel_association_for_service(self):
        ...
        return create_lan_vpn_and_routing_ospfv3_i_pv6_parcel_association_for_service_(self._request_adapter)
    ...
    def edit_lan_vpn_and_routing_ospfv3_i_pv6_parcel_association_for_service(self):
        ...
        return edit_lan_vpn_and_routing_ospfv3_i_pv6_parcel_association_for_service_(self._request_adapter)
