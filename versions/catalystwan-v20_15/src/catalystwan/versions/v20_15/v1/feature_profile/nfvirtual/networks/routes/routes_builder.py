...
class RoutesBuilder:
    ...
    @property
    def create_nfvirtual_routes_parcel(self):
        class create_nfvirtual_routes_parcel_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return create_nfvirtual_routes_parcel_(self._request_adapter)
    ...
    @property
    def edit_nfvirtual_routes_parcel(self):
        class edit_nfvirtual_routes_parcel_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter

            def __call__(self, networks_id: str, routes_id: str, payload: Optional[str] = None, **kw) -> str:
                """
        ...
        return edit_nfvirtual_routes_parcel_(self._request_adapter)
