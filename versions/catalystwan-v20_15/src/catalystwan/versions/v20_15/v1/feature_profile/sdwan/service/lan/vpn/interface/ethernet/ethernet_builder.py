...
class EthernetBuilder:
    ...
    @property
    def create_lan_vpn_interface_ethernet_parcel_for_service(self):
        class create_lan_vpn_interface_ethernet_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
    ...
    @property
    def edit_lan_vpn_interface_ethernet_parcel_for_service(self):
        class edit_lan_vpn_interface_ethernet_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
