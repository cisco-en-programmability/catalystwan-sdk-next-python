...
@dataclass
class SsidConfig:
    qos_settings: Optional[str] = _field(
        default=None, metadata={"alias": "qosSettings"}
    )
    security_auth_type: Optional[str] = _field(
        default=None, metadata={"alias": "securityAuthType"}
    )
...
class CorporateWifi:
    ...
    corporate_wlan: Optional[bool] = _field(
        default=None, metadata={"alias": "corporateWlan"}
    )
    radius_server: Optional[RadiusServer] = _field(
        default=None, metadata={"alias": "radiusServer"}
    )
    ssid: Optional[str] = _field(default=None)
    visibility: Optional[bool] = _field(default=None)
    wpa_psk_key: Optional[str] = _field(default=None, metadata={"alias": "wpaPskKey"})
...
class RadioBandSetting24G:
    ...
    channel_width: Optional[str] = _field(
        default=None, metadata={"alias": "channelWidth"}
    )
    transmit_power: Optional[str] = _field(
        default=None, metadata={"alias": "transmitPower"}
    )
...
class CountryRegionSettings:
    country_region: Optional[str] = _field(
        default=None, metadata={"alias": "countryRegion"}
    )
    regulatory_domain: Optional[str] = _field(
        default=None, metadata={"alias": "regulatoryDomain"}
    )
...
class CreateWifiProfileParcelForMobilityPostRequest:
    ...
    guest_wifi: Optional[GuestWifi] = _field(
        default=None, metadata={"alias": "guestWifi"}
    )
