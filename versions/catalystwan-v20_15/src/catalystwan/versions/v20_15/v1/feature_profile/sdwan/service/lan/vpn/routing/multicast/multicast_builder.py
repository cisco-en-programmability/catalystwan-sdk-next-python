...
class MulticastBuilder:
    ...
    def get_lan_vpn_associated_routing_multicast_parcels_for_service(self, service_id: str, vpn_id: str, **kw) -> str:
        """
    ...
    def create_lan_vpn_and_routing_multicast_parcel_association_for_service(self):
        ...
        return create_lan_vpn_and_routing_multicast_parcel_association_for_service_(self._request_adapter)
    ...
    def edit_lan_vpn_and_routing_multicast_parcel_association_for_service(self):
        ...
        return edit_lan_vpn_and_routing_multicast_parcel_association_for_service_(self._request_adapter)
