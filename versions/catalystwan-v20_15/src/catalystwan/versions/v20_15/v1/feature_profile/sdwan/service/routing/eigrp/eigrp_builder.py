...
class EigrpBuilder:
    ...
    @property
    def create_routing_eigrp_profile_parcel_for_service(self):
        class create_routing_eigrp_profile_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
    ...
    @property
    def edit_routing_eigrp_profile_parcel_for_service(self):
        class edit_routing_eigrp_profile_parcel_for_service_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
