...
class DevicesDetailsLicenses:
    ...
    license_category: Optional[str] = _field(
        default=None, metadata={"alias": "licenseCategory"}
    )
...
class DevicesDetailsDevices:
    compliance_status: Optional[str] = _field(
        default=None, metadata={"alias": "complianceStatus"}
    )
    ...
    device_tags: Optional[List[str]] = _field(
        default=None, metadata={"alias": "deviceTags"}
    )
