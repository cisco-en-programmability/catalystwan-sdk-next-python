...
class DevicesDetailsLicenses:
    ...
    no0f_assigned_licenses: Optional[int] = _field(default=None, metadata={"alias": "no0fAssignedLicenses"})
...
class DevicesDetailsDevices:
    ...
    in_compliant_reason: Optional[str] = _field(default=None, metadata={"alias": "inCompliantReason"})
    licenses: Optional[List[DevicesDetailsLicenses]] = _field(default=None)
    no_of_tenants_on_boarded: Optional[int] = _field(default=None, metadata={"alias": "noOfTenantsOnBoarded"})
