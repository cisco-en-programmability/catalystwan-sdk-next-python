...
class LocalDestination:
    ...
    backup_ttl_in_days: Optional[int] = _field(
        default=None, metadata={"alias": "backupTTLInDays"}
    )
    # Number of replicas of the database backup file
    num_of_replica: Optional[int] = _field(
        default=None, metadata={"alias": "numOfReplica"}
    )
...
class LocalBackupInfo:
    ...
    backup_state: Optional[str] = _field(
        default=None, metadata={"alias": "backupState"}
    )
    ...
    download_url: Optional[str] = _field(
        default=None, metadata={"alias": "downloadURL"}
    )
    ...
    src_ip_address: Optional[str] = _field(
        default=None, metadata={"alias": "srcIpAddress"}
    )
