...
class NwpiDomainMonitorStateRespPayloadDevicelist:
    ...
    dscp_is_valid: Optional[str] = _field(
        default=None, metadata={"alias": "dscp-is-valid"}
    )
    ...
    parent_trace_id: Optional[int] = _field(
        default=None, metadata={"alias": "parent-trace-id"}
    )
...
class NwpiTraceHistoryRespPayloadDataSummary:
    ...
    agg_user_name: Optional[str] = _field(
        default=None, metadata={"alias": "agg-user-name"}
    )
    ...
    device_ip: Optional[str] = _field(default=None, metadata={"alias": "device-ip"})
    devices_check_info: Optional[str] = _field(
        default=None, metadata={"alias": "devicesCheckInfo"}
    )
    dia_vis: Optional[str] = _field(default=None, metadata={"alias": "dia-vis"})
    domain_mon: Optional[str] = _field(default=None, metadata={"alias": "domain-mon"})
    ...
    health_cpu_core: Optional[str] = _field(
        default=None, metadata={"alias": "health-cpu-core"}
    )
    health_cpu_load: Optional[str] = _field(
        default=None, metadata={"alias": "health-cpu-load"}
    )
    health_cpu_load_average: Optional[str] = _field(
        default=None, metadata={"alias": "health-cpu-load-average"}
    )
    health_mem_usage: Optional[str] = _field(
        default=None, metadata={"alias": "health-mem-usage"}
    )
    health_running_traces: Optional[int] = _field(
        default=None, metadata={"alias": "health-running-traces"}
    )
    health_server_ip: Optional[str] = _field(
        default=None, metadata={"alias": "health-server-ip"}
    )
...
class NwpiTraceHistoryRespPayloadData:
    devices: Optional[List[NwpiDomainMonitorStateRespPayloadDevicelist]] = _field(
        default=None
    )
