...
class EventReadoutResponsePayloadInner:
    ...
    drop_send_pkts: Optional[List[Any]] = _field(
    ...
    event_list: Optional[List[Any]] = _field(
        default=None, metadata={"alias": "eventList"}
    )
    event_num: Optional[List[Any]] = _field(
        default=None, metadata={"alias": "eventNum"}
    )
    readout_agg_flag: Optional[bool] = _field(
        default=None, metadata={"alias": "readoutAggFlag"}
    )
