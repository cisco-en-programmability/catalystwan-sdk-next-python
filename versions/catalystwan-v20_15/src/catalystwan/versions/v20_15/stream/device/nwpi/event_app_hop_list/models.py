...
class EventAppHopListResponsePayloadInner:
    ...
    down_hop_list_info: Optional[List[Any]] = _field(default=None, metadata={"alias": "downHopListInfo"})
    ...
    up_hop_list_info: Optional[List[Any]] = _field(default=None, metadata={"alias": "upHopListInfo"})
