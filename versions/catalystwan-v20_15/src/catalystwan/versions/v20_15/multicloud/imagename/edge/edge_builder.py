...
class EdgeBuilder:
    ...
    def get_supported_edge_image_names(self, edge_type: Optional[EdgeTypeParam] = "MEGAPORT", **kw) -> Any:
        """
        ...
        return self._request_adapter.request("GET", "/dataservice/multicloud/imagename/edge", params=params, **kw)
