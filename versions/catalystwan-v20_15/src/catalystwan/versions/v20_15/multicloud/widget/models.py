...
class AllOfcloudWidgetCgwDeviceStatus:
    count: Optional[int] = _field(default=None)
    name: Optional[str] = _field(default=None)
    status_list: Optional[List[WidgetStatusStatusList]] = _field(default=None, metadata={"alias": "statusList"})
...
@dataclass
class CloudWidget:
    cgw_device_site_ids: Optional[List[str]] = _field(default=None, metadata={"alias": "cgwDeviceSiteIds"})
    cgw_device_status: Optional[AllOfcloudWidgetCgwDeviceStatus] = _field(
        default=None, metadata={"alias": "cgwDeviceStatus"}
    )
    cgw_sites_status: Optional[WidgetStatus] = _field(default=None, metadata={"alias": "cgwSitesStatus"})
