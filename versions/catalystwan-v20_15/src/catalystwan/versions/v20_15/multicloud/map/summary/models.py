...
class MapSummaryAccountId:
    site_to_cloud_ncc_hub_name: Optional[str] = _field(default=None, metadata={"alias": "Site To Cloud NCC Hub Name"})
    ...
    site_to_cloud_vpc_id: Optional[str] = _field(default=None, metadata={"alias": "Site To Cloud VPC ID"})
    site_to_cloud_vpc_name: Optional[str] = _field(default=None, metadata={"alias": "Site To Cloud VPC Name"})
    site_to_site_ncc_hub_name: Optional[str] = _field(default=None, metadata={"alias": "Site To Site NCC Hub Name"})
    site_to_site_vpc_id: Optional[str] = _field(default=None, metadata={"alias": "Site To Site VPC ID"})
    site_to_site_vpc_name: Optional[str] = _field(default=None, metadata={"alias": "Site To Site VPC Name"})
...
@dataclass
class MapSummary:
    account_id: Optional[MapSummaryAccountId] = _field(default=None, metadata={"alias": "Account ID"})
    account_name: Optional[str] = _field(default=None, metadata={"alias": "accountName"})
    additional_details: Optional[str] = _field(default=None, metadata={"alias": "additionalDetails"})
    azure_virtual_wan_hub_id: Optional[str] = _field(default=None, metadata={"alias": "Azure Virtual WAN Hub ID"})
    ...
    connectivity_state_update_ts: Optional[str] = _field(default=None, metadata={"alias": "connectivityStateUpdateTs"})
