...
class CloudGatewayListResponse:
    ...
    cloud_gateway_id: Optional[str] = _field(
        default=None, metadata={"alias": "cloudGatewayId"}
    )
    ...
    custom_settings: Optional[bool] = _field(
        default=None, metadata={"alias": "customSettings"}
    )
...
class CloudGatewayPostAzureProperties:
    ...
    vpn_gateway_source: Optional[str] = _field(
        default=None, metadata={"alias": "vpnGatewaySource"}
    )
...
class CloudGatewayPostConfigGroupSettings:
    ...
    config_group_id: Optional[str] = _field(
        default=None, metadata={"alias": "configGroupId"}
    )
    config_group_name: Optional[str] = _field(
        default=None, metadata={"alias": "configGroupName"}
    )
...
class AllOfcloudGatewayPostSettings:
    ...
    cloud_type: Optional[str] = _field(default=None, metadata={"alias": "cloudType"})
    instance_size: Optional[str] = _field(
        default=None, metadata={"alias": "instanceSize"}
    )
    ...
    network_tier: Optional[str] = _field(
        default=None, metadata={"alias": "networkTier"}
    )
    # Used for Azure/Azure GovCloud Custom settings
    sku_scale_unit: Optional[str] = _field(
        default=None, metadata={"alias": "skuScaleUnit"}
    )
    ...
    tunnel_count: Optional[str] = _field(
...
class CloudGatewayPost:
    ...
    cloud_gateway_mode: Optional[str] = _field(
        default=None, metadata={"alias": "cloudGatewayMode"}
    )
    cloud_gateway_solution: Optional[str] = _field(
        default=None, metadata={"alias": "cloudGatewaySolution"}
    )
    cloud_gateway_tag: Optional[str] = _field(
        default=None, metadata={"alias": "cloudGatewayTag"}
    )
    # Used in Azure/Azure GovCloud CGW creation
    ...
    region: Optional[str] = _field(default=None)
    s2s_permitted: Optional[str] = _field(
        default=None, metadata={"alias": "s2sPermitted"}
    )
...
class TunnelsInner:
    ...
    outer_ip_addr: Optional[str] = _field(
        default=None, metadata={"alias": "outerIpAddr"}
    )
    status: Optional[str] = _field(default=None)
    ...
    tunnel_inner_ip: Optional[List[str]] = _field(
        default=None, metadata={"alias": "tunnelInnerIp"}
    )
...
class CloudGatewayAdjusted:
    ...
    # CGW details relevant to AWS/AWS_GOVCLOUD
    cloud_provider_asn: Optional[int] = _field(
        default=None, metadata={"alias": "cloudProviderASN"}
    )
    # CGW details relevant to AWS/AWS_GOVCLOUD
    ...
    cloud_type: Optional[str] = _field(default=None, metadata={"alias": "cloudType"})
    connected_sites: Optional[int] = _field(
        default=None, metadata={"alias": "connectedSites"}
    )
    ...
    # CGW details relevant to AWS/AWS_GOVCLOUD
    route_table_count: Optional[str] = _field(
        default=None, metadata={"alias": "routeTableCount"}
    )
    # Only applicable to GCP CloudGateways
    s2s_permitted: Optional[bool] = _field(
        default=None, metadata={"alias": "s2sPermitted"}
    )
...
class UpdateCgwDeviceChanges:
    ...
    devices_added: Optional[List[str]] = _field(
        default=None, metadata={"alias": "devicesAdded"}
    )
