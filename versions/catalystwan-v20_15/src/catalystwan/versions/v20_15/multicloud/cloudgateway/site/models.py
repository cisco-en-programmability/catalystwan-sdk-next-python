...
class GetSitesResponse:
    accelerated_vpn: Optional[bool] = _field(
        default=None, metadata={"alias": "acceleratedVpn"}
    )
    agg_tunnel_status: Optional[str] = _field(
        default=None, metadata={"alias": "aggTunnelStatus"}
    )
...
class TunnelScalingRequestPayload:
    cloud_type: str = _field(metadata={"alias": "cloudType"})
    branch_endpoints: Optional[List[TunnelScalingRequestPayloadBranchEndpoints]] = (
        _field(default=None, metadata={"alias": "branchEndpoints"})
    )
...
class AttachSitesRequestPayloadInner:
    ...
    system_ip: str = _field(metadata={"alias": "systemIp"})
    tunnel_count: str = _field(metadata={"alias": "tunnelCount"})
    accelerated_vpn: Optional[str] = _field(
        default=None, metadata={"alias": "acceleratedVpn"}
    )
    interface: Optional[str] = _field(default=None)
    preferred_interface: Optional[str] = _field(
