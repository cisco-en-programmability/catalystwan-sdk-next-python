...
class NvaSkuListResponseScaleValueList:
    instance_count: Optional[int] = _field(
        default=None, metadata={"alias": "instanceCount"}
    )
    instance_type: Optional[str] = _field(
        default=None, metadata={"alias": "instanceType"}
    )
...
class NvaSkuListResponse:
    ...
    version_list: Optional[List[str]] = _field(
        default=None, metadata={"alias": "versionList"}
    )
