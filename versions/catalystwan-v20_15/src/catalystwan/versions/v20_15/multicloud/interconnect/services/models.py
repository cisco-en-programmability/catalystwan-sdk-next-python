...
class InterconnectService:
    ...
    interface_count: Optional[str] = _field(
        default=None, metadata={"alias": "interfaceCount"}
    )
    ...
    service_region: Optional[str] = _field(
        default=None, metadata={"alias": "serviceRegion"}
    )
    # HA role of the service
    service_role: Optional[str] = _field(
        default=None, metadata={"alias": "serviceRole"}
    )
