...
class InlineResponse20012:
    ...
    dl_metro_bandwidth: Optional[int] = _field(
        default=None, metadata={"alias": "dlMetroBandwidth"}
    )
...
class InterconnectDeviceLinkDeviceList:
    ...
    egw_loop_back_cidr: Optional[str] = _field(
        default=None, metadata={"alias": "egwLoopBackCidr"}
    )
...
class InterconnectDeviceLink:
    ...
    device_link_uuid: Optional[str] = _field(
        default=None, metadata={"alias": "deviceLinkUuid"}
    )
    # Subnet pool for Interconnect Gateway interfaces in the Device-Link.
    device_linksubnet: Optional[str] = _field(
        default=None, metadata={"alias": "deviceLinksubnet"}
    )
    ...
    dl_metro_bandwidth: Optional[str] = _field(
        default=None, metadata={"alias": "dlMetroBandwidth"}
    )
    ...
    link_bandwidth: Optional[str] = _field(
        default=None, metadata={"alias": "linkBandwidth"}
    )
