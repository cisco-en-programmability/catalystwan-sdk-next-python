...
class InterconnectDashboardConnections:
    connectivity_name: Optional[str] = _field(
        default=None, metadata={"alias": "connectivityName"}
    )
...
class InterconnectDashboardLinkList:
    device_link_name: Optional[str] = _field(
        default=None, metadata={"alias": "deviceLinkName"}
    )
    resource_state: Optional[str] = _field(
        default=None, metadata={"alias": "resourceState"}
    )
...
class InterconnectDashboard:
    ...
    edge_account_id: Optional[str] = _field(
        default=None, metadata={"alias": "edgeAccountId"}
    )
    ...
    edge_gateway_name: Optional[str] = _field(
        default=None, metadata={"alias": "edgeGatewayName"}
    )
