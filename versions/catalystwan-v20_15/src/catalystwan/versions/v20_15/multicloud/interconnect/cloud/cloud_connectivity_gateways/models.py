...
class GatewayAssociationAssociatedGateway:
    ...
    cloud_account_id: Optional[str] = _field(
        default=None, metadata={"alias": "cloudAccountId"}
    )
    ...
    gateway_name: Optional[str] = _field(
        default=None, metadata={"alias": "gatewayName"}
    )
...
class GatewayAssociation:
    ...
    association_id: Optional[str] = _field(
        default=None, metadata={"alias": "associationId"}
    )
    association_state: Optional[str] = _field(
        default=None, metadata={"alias": "associationState"}
    )
    state_change_error: Optional[str] = _field(
        default=None, metadata={"alias": "stateChangeError"}
    )
...
class AwsDirectConnectGatewayVirtualInterfaceAttachmentList:
    ...
    attachment_state: Optional[str] = _field(
        default=None, metadata={"alias": "attachmentState"}
    )
    cloud_type: Optional[CloudType] = _field(
        default=None, metadata={"alias": "cloudType"}
    )
    # Id of the private cross connect
    connection_id: Optional[str] = _field(
        default=None, metadata={"alias": "connectionId"}
    )
    # Type of AWS connection
    connection_type: Optional[ConnectionType] = _field(
        default=None, metadata={"alias": "connectionType"}
    )
    owner_account: Optional[str] = _field(
        default=None, metadata={"alias": "ownerAccount"}
    )
    region: Optional[str] = _field(default=None)
    state_change_error: Optional[str] = _field(
        default=None, metadata={"alias": "stateChangeError"}
    ...
    # VIrtual Interface Object
    virtual_interface_data: Optional[AwsDirectConnectGatewayVirtualInterfaceData] = (
        _field(default=None, metadata={"alias": "virtualInterfaceData"})
    )
...
class AwsTransitGateway:
    ...
    creation_time: Optional[str] = _field(
    ...
    multicast_support: Optional[bool] = _field(
        default=None, metadata={"alias": "multicastSupport"}
    )
    owner_account: Optional[str] = _field(
        default=None, metadata={"alias": "ownerAccount"}
    )
    ...
    vpn_ecmp_support: Optional[bool] = _field(
        default=None, metadata={"alias": "vpnEcmpSupport"}
    )
...
class AwsVirtualPrivateGateway:
    ...
    amazon_side_asn: Optional[int] = _field(
        default=None, metadata={"alias": "amazonSideAsn"}
    )
    availability_zone: Optional[str] = _field(
        default=None, metadata={"alias": "availabilityZone"}
    )
    # List of VPC attachments
    vpc_attachment_list: Optional[List[AwsVpcAttachments]] = _field(
        default=None, metadata={"alias": "vpcAttachmentList"}
...
class AzureErcPeering:
    ...
    peering_state: Optional[PeeringState] = _field(
        default=None, metadata={"alias": "peeringState"}
    )
    peering_type: Optional[PeeringType] = _field(
        default=None, metadata={"alias": "peeringType"}
    )
    primary_azure_port: Optional[str] = _field(
        default=None, metadata={"alias": "primaryAzurePort"}
    )
...
class AzureErcServiceProviderProperties:
    ...
    bandwidth_in_mbps: Optional[int] = _field(
        default=None, metadata={"alias": "bandwidthInMbps"}
    )
    peering_location: Optional[str] = _field(
        default=None, metadata={"alias": "peeringLocation"}
    )
...
class AzureVirtualHub:
    ...
    address_prefix: Optional[str] = _field(
        default=None, metadata={"alias": "addressPrefix"}
    )
    cloud_type: Optional[CloudType] = _field(
        default=None, metadata={"alias": "cloudType"}
    )
    ...
    routing_state: Optional[str] = _field(
        default=None, metadata={"alias": "routingState"}
    )
...
class AzureExpressRouteCircuitVnetTagNamesForConnections:
    ...
    is_delete: Optional[bool] = _field(default=None, metadata={"alias": "isDelete"})
    vnet_tag_name: Optional[str] = _field(
        default=None, metadata={"alias": "vnetTagName"}
    )
...
class AzureExpressRouteCircuit:
    ...
    bandwidth_in_gbps: Optional[int] = _field(
        default=None, metadata={"alias": "bandwidthInGbps"}
    )
    gateway_association_list: Optional[List[GatewayAssociation]] = _field(
        default=None, metadata={"alias": "gatewayAssociationList"}
    )
    ...
    service_provider_provisioning_state: Optional[ServiceProviderProvisioningState] = (
        _field(default=None, metadata={"alias": "serviceProviderProvisioningState"})
    )
    # Express Route Circuit SKU
    ...
    ] = _field(default=None, metadata={"alias": "vWanAttachmentList"})
...
class AzureVirtualNetworkGateway:
    ...
    public_ip_address: Optional[str] = _field(
        default=None, metadata={"alias": "publicIPAddress"}
    )
    # VNET Gateway SKU parameters
...
class CloudConnectivityGatewayGcp:
    ...
    interconnect_asn: Optional[str] = _field(
        default=None, metadata={"alias": "interconnectAsn"}
    )
    pairing_key: Optional[str] = _field(default=None, metadata={"alias": "pairingKey"})
