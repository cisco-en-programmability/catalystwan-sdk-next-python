...
class InterconnectLicense:
    current_status: Optional[str] = _field(
        default=None, metadata={"alias": "currentStatus"}
    )
    ...
    smart_account_id: Optional[str] = _field(
        default=None, metadata={"alias": "smartAccountId"}
    )
    ...
    virtual_account_id: Optional[str] = _field(
        default=None, metadata={"alias": "virtualAccountId"}
    )
    vxc_bandwidth: Optional[str] = _field(
        default=None, metadata={"alias": "vxcBandwidth"}
    )
