...
class InterconnectLicense:
    ...
    sku_days_for_expiry: Optional[int] = _field(default=None, metadata={"alias": "skuDaysForExpiry"})
    ...
    subscription_reference_id: Optional[str] = _field(default=None, metadata={"alias": "subscriptionReferenceId"})
    technical_service_uid: Optional[str] = _field(default=None, metadata={"alias": "technicalServiceUid"})
