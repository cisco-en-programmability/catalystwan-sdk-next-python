...
class ClientServerResponseData:
    ...
    external_user: Optional[bool] = _field(
        default=None, metadata={"alias": "externalUser"}
    )
    general_template: Optional[bool] = _field(
        default=None, metadata={"alias": "generalTemplate"}
    )
    is_rbac_vpn_user: Optional[bool] = _field(
        default=None, metadata={"alias": "isRbacVpnUser"}
    )
    is_saml_user: Optional[bool] = _field(
        default=None, metadata={"alias": "isSamlUser"}
    )
    is_ui_allowed: Optional[bool] = _field(
        default=None, metadata={"alias": "isUiAllowed"}
    )
    locale: Optional[str] = _field(default=None)
    platform_version: Optional[str] = _field(
        default=None, metadata={"alias": "platformVersion"}
    )
    ...
    tenancy_mode: Optional[str] = _field(
        default=None, metadata={"alias": "tenancyMode"}
    )
    ...
    vmanage_mode: Optional[str] = _field(
        default=None, metadata={"alias": "vmanageMode"}
    )
