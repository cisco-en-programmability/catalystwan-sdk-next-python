...
class AggregationBuilder:
    ...
    @property
    def get_post_aggregation_data_by_query_2(self):
        class get_post_aggregation_data_by_query_2_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return get_post_aggregation_data_by_query_2_(self._request_adapter)
