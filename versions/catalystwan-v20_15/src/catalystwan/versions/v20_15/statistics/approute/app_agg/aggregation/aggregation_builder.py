...
class AggregationBuilder:
    ...
    @property
    def get_post_aggregation_app_data_by_query9(self):
        class get_post_aggregation_app_data_by_query9_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return get_post_aggregation_app_data_by_query9_(self._request_adapter)
