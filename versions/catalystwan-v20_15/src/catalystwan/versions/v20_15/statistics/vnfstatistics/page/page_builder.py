...
class PageBuilder:
    ...
    def get_stats_pagination_raw_data_9(
        ...
        return self._request_adapter.request("GET", "/dataservice/statistics/vnfstatistics/page", params=params, **kw)
    ...
    def get_post_stats_pagination_raw_data_9(
        ...
        return self._request_adapter.request(
            "POST", "/dataservice/statistics/vnfstatistics/page", params=params, payload=payload, **kw
        )
