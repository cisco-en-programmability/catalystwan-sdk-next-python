...
class AggregationBuilder:
    ...
    @property
    def get_post_aggregation_data_by_query_11(self):
        class get_post_aggregation_data_by_query_11_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
        ...
        return get_post_aggregation_data_by_query_11_(self._request_adapter)
