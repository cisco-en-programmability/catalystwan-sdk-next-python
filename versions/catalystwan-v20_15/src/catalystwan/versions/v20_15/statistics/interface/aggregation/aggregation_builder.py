...
class AggregationBuilder:
    ...
    def get_aggregation_data_by_query_11(self, query: str, **kw) -> List[InterfaceAggRespWithPageInfo]:
        """
    ...
    def get_post_aggregation_data_by_query_11(self, payload: Optional[Any] = None, **kw) -> List[InterfaceAggResp]:
        """
        Get aggregated data based on input query and filters. The data can be filtered on time and other unique parameters based upon necessity and intended usage
