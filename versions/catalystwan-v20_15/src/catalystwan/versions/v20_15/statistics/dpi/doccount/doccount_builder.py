...
class DoccountBuilder:
    ...
    def get_dpi_stats_count(self, query: Optional[str] = None, **kw) -> CountResponse:
        ...
        return self._request_adapter.request(
            "GET", "/dataservice/statistics/dpi/doccount", return_type=CountResponse, params=params, **kw
        )
    ...
    def get_dpi_stats_count_post(self, payload: Optional[Any] = None, **kw) -> CountResponse:
        ...
        """
        return self._request_adapter.request(
            "POST", "/dataservice/statistics/dpi/doccount", return_type=CountResponse, payload=payload, **kw
        )
