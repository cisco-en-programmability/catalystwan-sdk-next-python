...
class FlowlogBuilder:
    ...
    @property
    def get_stat_data_raw_data_post(self):
        class get_stat_data_raw_data_post_:
            def __init__(self, request_adapter: RequestAdapterInterface) -> None:
                self._request_adapter = request_adapter
            ...
            def __call__(
                ...
                **kw,
                ...
                return self._request_adapter.request(
                    "POST",
                    "/dataservice/statistics/flowlog",
                    params=params,
                    payload=payload,
                    **kw,
                )
        ...
        return get_stat_data_raw_data_post_(self._request_adapter)
