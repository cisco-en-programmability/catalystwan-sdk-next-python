...
class PageBuilder:
    ...
    def get_stats_pagination_raw_data_17(
        ...
        return self._request_adapter.request("GET", "/dataservice/statistics/wlanclientinfo/page", params=params, **kw)
    ...
    def get_post_stats_pagination_raw_data_17(
        ...
        return self._request_adapter.request(
            "POST", "/dataservice/statistics/wlanclientinfo/page", params=params, payload=payload, **kw
        )
