...
class PreferredpathBuilder:
    ...
    def get_o365_preferred_path_from_v_analytics(self):
        class get_o365_preferred_path_from_v_analytics_:
            ...
            def __call__(self, payload: Optional[GetO365PreferredPathFromVAnalyticsPostRequest] = None, **kw):
                """
            ...
            def create_payload(self, *args, **kwargs) -> GetO365PreferredPathFromVAnalyticsPostRequest:
                return GetO365PreferredPathFromVAnalyticsPostRequest(*args, **kwargs)

            @property
            def payload_model(self) -> Type[GetO365PreferredPathFromVAnalyticsPostRequest]:
