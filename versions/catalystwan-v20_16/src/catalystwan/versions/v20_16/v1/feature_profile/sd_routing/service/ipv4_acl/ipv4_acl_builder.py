...
class Ipv4AclBuilder:
    ...
    def get_sdrouting_service_ipv4_acl_features(self, service_id: str, **kw) -> str:
        """
    ...
    def edit_sdrouting_service_ipv4_acl_feature(
        self, service_id: str, ipv4_acl_id: str, payload: Optional[str] = None, **kw
    ) -> str:
        """
    ...
    def delete_sdrouting_service_ipv4_acl_feature(self, service_id: str, ipv4_acl_id: str, **kw):
        """
