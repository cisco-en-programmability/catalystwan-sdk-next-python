...
class ObjecttrackerBuilder:
    ...
    def get_sdrouting_transport_object_tracker_features(self, transport_id: str, **kw) -> str:
        """
    ...
    def edit_sdrouting_transport_object_tracker_feature(
        self, transport_id: str, object_tracker_id: str, payload: Optional[str] = None, **kw
    ) -> str:
        """
