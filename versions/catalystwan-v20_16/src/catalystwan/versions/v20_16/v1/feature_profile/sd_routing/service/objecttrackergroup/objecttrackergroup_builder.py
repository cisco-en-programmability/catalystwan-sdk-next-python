...
class ObjecttrackergroupBuilder:
    ...
    def get_sdrouting_service_object_tracker_group_features(self, service_id: str, **kw) -> str:
        """
    ...
    def edit_sdrouting_service_object_tracker_group_feature(
        self, service_id: str, object_tracker_group_id: str, payload: Optional[str] = None, **kw
    ) -> str:
        """
